...
1
0 10 0 1
((2 - var0) * var0 * 2) + ((2 - var1) * var1 * 2) + ((2 - var2) * var2 * 2) + ((2 - var3) * var3 * 2) + ((2 - var4) * var4 * 2) + (abs(1 - var5) * (2 - var5)) + (abs(1 - var6) * (2 - var6)) + (abs(1 - var7) * (2 - var7)) + (abs(1 - var8) * (2 - var8)) + (abs(1 - var9) * (2 - var9)) 
end_operator
begin_operator
move r b
0
